function iRollTrackerFrame_EditBox_OnLoad(self)
...
function iRollTrackerFrame_EditBox_OnTextChanged(self)
...
function iRollTrackerFrame_EditBox_ButtonClear_OnClick(self, button, down)
...
function iRollTrackerFrame_Scroll_OnScrollRangeChanged(self, xrange, yrange)
